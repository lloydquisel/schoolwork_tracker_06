...
<div>
    <div class="container h-100 mt-2">
        ...
        <div class="border-bottom border-secondary pb-3 mb-3">
            <h1 class="d-inline display-4 ml-2">Subjects Management</h1>
            <a class="btn btn-success btn-lg text-white float-right d-inline mt-3 mr-2" type="button" data-toggle="modal" data-target="#createModal">New Subject</a>
        </div>
